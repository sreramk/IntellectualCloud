...
public class addnewemp extends AppCompatActivity {
    ...
    private static final String DB_URL = "https://intellectualcloud-5fe7b.firebaseio.com/Team";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addnewemp);
        getSupportActionBar().setTitle("Add new Employee");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        et_con = findViewById(R.id.empcontent);
        et_desc = findViewById(R.id.empdescription);
        et_title = findViewById(R.id.empname);
        btn_choosepic = findViewById(R.id.choosepice);
        btn_submit = findViewById(R.id.submite);
    ...
    private void startposting() {
        ProgressDialog pd = new ProgressDialog(addnewemp.this);
        ...
        finish();
        startActivity(new Intent(addnewemp.this, Home.class));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                ImageView imageView = (ImageView) findViewById(R.id.choosepice);
